...
charts(FusionCharts)
  var myDataSource = {
    ...
    categories: [
      {
        category: [{ label: "Jan" }, { label: "Feb" }, { label: "Mar" }, { label: "Apr" }, { label: "May" }, { label: "Jun" }, { label: "Jan" }, { label: "Feb" }, { label: "Mar" }, { label: "Apr" }, { label: "May" }, { label: "Jun" }]
      }
    ],
    dataset: [
      {
        seriesname: "Total number of NEG thoughts",
        data: [
          {
            value: "16"
          },
              ...
              <div className="card">
                ...
                <div className="card-content">
                  ...
                  <div className="content">
                    ...
                    <br />
                    <time time={timestamp}>~{timestamp} </time>
                  </div>
